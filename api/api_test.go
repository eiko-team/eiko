...
func TestGet400(t *testing.T) {
	...
	tests := []struct {
		...
		{"json autocomplete_data", "GET", "/json/autocomplete_data.json", http.StatusOK, false, "application/json"},
		{"json manifest", "GET", "/json/manifest.json", http.StatusOK, false, "application/json"},
